  ...
  ActiveAdmin::Views::Pages::Base.class_eval do
    def build_active_admin_head
      within head do
        ...
        # BEGIN the whole reason we had to override this stupid ass layout
        # in order to make sure google analytics is included in our ActiveAdmin pages
        raw_js = "
